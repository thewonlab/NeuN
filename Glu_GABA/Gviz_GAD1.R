...
chromosome="chr2"  #Define the chromosome number
...
GeneModel<-BiomartGeneRegionTrack(genome="hg19", biomart=mart, chromosome=chromosome,
            start=170500000, end=171900000, showId=T, geneSymbols=T,
...
htrack1<-HighlightTrack(trackList=GeneModel, start=unique(start(tss_GABA)), width=10000, chromosome=chromosome, fill="gray", alpha=0.5, col="#00000000")
...
plotTracks(c(itrack,gtrack,htrack1,peak_track1,peak_track3,peak_track2,peak_track4,htrack3,tad_track1,tad_track2),collapseTranscripts="meta",shape="arrow",from=170500000, to=171900000,
